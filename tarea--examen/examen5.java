...
;
    ...
    if(Mbase >2000 ){
      ...
      igv = Mbase*0.18;
      System.out.println("su artefacto no tiene descuento, su precio es: "+Mbase);
      System.out.print("su igv de su artefacto es: "+igv);
    }
    ...
    }else if("R".equalsIgnoreCase(operacion)){
